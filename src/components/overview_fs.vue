<template>
    <div ref="overview">
        ...
        <div class="overview">
            <div class="wrapbox">
                <!-- 广播 LCD 视频 -- 设备状态 -->
                <div class="o_box trans-up trans-up-delay-3" v-if="$route.name==='broadcast'||$route.name==='video'||$route.name==='lcd'||$route.name==='visualIntercom'">
                    <div class="box-title">
                    ...
                    <div class="group">
                        <div class="group1 clearfix">
                            <div class="groupalgin">
                                ...
                                <i class="icons" v-if="$route.name==='video'">&#xe67e;</i>
                ...
                <!-- 广播 LCD 视频 -- 折线图 -->
                <div class="o_box trans-up trans-up-delay-5" v-if="$route.name==='broadcast'||$route.name==='video'||$route.name==='lcd'||$route.name==='visualIntercom'">
                    <div class="box-title">
                        <span class="icons color-huang">&#xe657;</span>
                        <span>告警统计</span>
                    </div>
                ...
                <!-- 广播 LCD 视频 -- 离线设备 -->
                <div class="o_box trans-up trans-up-delay-7" v-if="$route.name==='broadcast'||$route.name==='video'||$route.name==='lcd'||$route.name==='visualIntercom'">
                    <div class="box-title">
                        <span class="icons color-huang">&#xe779;</span>
                        <span>离线设备</span>
                    </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            //vuex
            getWsData:function() {
                if (this.$store.getters.websocketData[230016]) {
                    this.eLoading = 0;
                    const wsMsg = this.$store.getters.websocketData[230016].msg;
                ...
                //离线设备
                if (this.$store.getters.websocketData[230017]) {
                    this.eLoading = 0;
                    const wsMsg = this.$store.getters.websocketData[230017].msg;
            ...
            initChart() {                
                ...
                if (this.$refs.myEchart) {
                    if (this.chartData.length > 0) {
                        if (this.chartData.sort().toString() == this.wsData.alarms.date.sort().toString()) {
                            return false;
                        }
                    } else {
