    ...
    <div class="header-c-wrap fl">
      <ul class="header-c">
        ...
        >
          ...
          <ul class="menu-second" :style="{'padding-left':(pageW*index+pageW/2-0.025*innerW)+'px'}">
            <li
            ...
            >
              <span class="header-icon" :class="urls.class"></span>
...
.h_r_btn_p span{transition: all .3s linear;}
...
.time_p{width: 100%;padding-left: .6rem}

.header-r .icons,.mainBtn{cursor: pointer;}
.header-r strong{position: absolute;left: 100%;top: 0;width: 100%;transition: all .3s linear;}
.header-r strong.come{left:0;}
.header-r strong span{margin: 0 .05rem;}
.come{text-align: center}
.come b{display: inline-block;cursor: pointer;}
